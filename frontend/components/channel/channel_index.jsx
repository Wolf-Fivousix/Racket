...
class ChannelIndex extends React.Component {
    ...
    destroyChannel() {
        // This is not good! With repeated channels I'll be deleting the first
        //  one found with that name. I'll be swapping all this once I convert
        // channelIndex to render ChannelShowContainers. This logic will be part of that.
        const channels = Object.values(this.props.channels)
        const channel = channels.filter(c => c.title === "Beep Boop")[0]
        this.props.destroyChannel(channel.id);
    }
